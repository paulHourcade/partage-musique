    ...
    <div style={styles.page}>
      ...
      <div style={styles.shell}>
        ...
        <div style={styles.bottomButtons}>
          <Link to="/app1" style={styles.bottomButton}>App 1</Link>
          <Link to="/app2" style={styles.bottomButton}>App 2</Link>
          <Link to="/app3" style={styles.bottomButton}>App 3</Link>
          <Link to="/app4" style={styles.bottomButton}>App 4</Link>
        </div>
      </div>
    </div>
  );
